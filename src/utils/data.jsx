import { FaBell, FaImage, FaLink, FaVideo, FaAd, FaCalendarAlt, FaMapMarkerAlt, FaBuilding, FaUsers, FaUserTie, FaTools, FaTasks, FaHome, FaShoppingCart, FaClipboardList, FaUser, FaBook, FaPlus, FaList } from 'react-icons/fa';
...
export const sidebarItems = [
...

  {
    ...
    subItems: [
      ...
      { path: '/dashboard/engineers/list', label: 'List Engineers', icon: FaList },
    ],
  },
  {
    label: 'Activities',
    icon: FaTasks,
    subItems: [
      { path: '/dashboard/activities/add', label: 'Add Activity', icon: FaPlus },
      { path: '/dashboard/activities/list', label: 'List Activities', icon: FaList },
    ],
  },
  {
    label: 'Property',
  ...
  
  {
    ...
    subItems: [
      ...
      { path: '/dashboard/team/list', label: 'List Team Members', icon: FaList },
    ],
  },
  {
    label: 'Portal Guide',
    icon: FaBook,
    subItems: [
      { path: '/dashboard/portal-guide/add', label: 'Add Portal Guide', icon: FaPlus },
      { path: '/dashboard/portal-guide/list', label: 'List Portal Guides', icon: FaList },
    ],
  },
  {
    label: 'User',
    icon: FaUser,
    subItems: [
      { path: '/dashboard/user/add', label: 'Add User', icon: FaPlus },
      { path: '/dashboard/user/list', label: 'List Users', icon: FaList },
    ],
  },
];
...
export const events = [
  {
    ...
    description: 'Join us for a fun-filled summer festival with music, food, and games!'
  },
  {
    id: '2',
    ...
    description: 'Experience the magic of winter with our Winter Wonderland event.'
  },
  {
    id: '3',
    title: 'Spring Gala',
  ...
  },
  {
    ...
    description: 'Join us for a harvest celebration with food, music, and fun activities.'
  }
];
...
export const facilities = [
  {
    ...
    images: [
      'https://example.com/gym-1.jpg',
      'https://example.com/gym-2.jpg'
    ],
  ...
  },
  {
    ...
    images: [
      'https://example.com/spa-1.jpg',
      'https://example.com/spa-2.jpg'
    ],
...
export const activities = [
  ...
  },
  {
    ...
    description: 'Experience the local culture with our annual cultural festival.',
    images: [
