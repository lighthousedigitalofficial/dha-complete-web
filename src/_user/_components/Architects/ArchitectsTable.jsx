const ArchitectsTable = () => {
	...
	const dealers = [
		...
		},
		{
			...
			ADDRESS:
				"1st Floor H&H-1 Centre River Gardens Housing Scheme Islamabad Express Way Islamabad",
		...
		},
		{
			...
			ADDRESS:
				"Office No 03, 2nd Floor, Cantt Plaza Chaklala Scheme III, Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"2nd Floor, 62/2, (Atalian Shoes Building), Bank Road, Rawalpindi Cantt",
		...
		},
		{
			...
			ADDRESS:
				"Office No 1, 4th Floor, Plot No 41, Awan Icon Arcade Plaza, Midway Commercial, Phase-7, Bahria Town, Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"Suite 4-C, 4th Floor, TaaSEEN Complex, Block B, Civic Centre Phase IV Bahria Town Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"Flat No 01, Amjad Arcade, Street No. 4 Gulraiz Phase-II, Commercial, Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"Suite # 101, 1st Floor, Royal Centre, Fazal-e-Haq Road, Blue Area Islamabad",
		...
		},
		{
			...
			ADDRESS:
				"House No 97, Street No 77, Services Cooperative Housing Society E-11/2 Islamabad",
		...
		},
		{
			...
			ADDRESS:
				"Office # 103, Al-Ahmed Heights, Sector A Opp Lignum Tower, Al-Ghurair Giga, DHA Phase-2 Main GT Road Islamabad",
		...
		},
		{
			...
			ADDRESS:
				"2nd Floor, Saffari Commercial Complex, Saffari Villas-2,Phase-VII, Baheria Town Rawal Pindi",
		...
		},
		{
			...
			ADDRESS:
				"1st Floor # 101 Sector CBD North, Mohsin Arcade, Opposite Bahria Head Office (new) Phase 8, Rawalpindi/Islamabad",
		...
		},
		{
			...
			ADDRESS:
				"18/62, Rafique Center, 1st Floor, Adamjee Road, Saddar, Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"Office No 7, Mezanine Floor, Prism Arcade-1, Phase-7, Bahria Town Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"3-C Basement Floor, Street # 65, Muslim Market, Sector F-10/3 Islamabad",
		...
		},
		{
			...
			ADDRESS:
				"Office No 7, 2nd Floor, Prism Arcade 1 Phase 7, Bahria Town Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"House # 101-A, St # 6, Gulraiz Housing Scheme, Phase III, High Court Road Rawalpindi",
		...
		},
		{
			...
			ADDRESS:
				"Taamer Plaza, 12 Hospital Blvd, Sector A, Behind Attock Fuel Station, DHA-2 Islamabad",
		...
		},
		{
			...
			ADDRESS:
				"Plaza 55, Street No 8, Walayat Complex, Bahria Phase 7, Islamabad",
