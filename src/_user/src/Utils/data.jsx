...
export const menuData = [
    ...
    subItems: [
      {
        ...
        DropDown: [
          ...
          {
            label: "Issuance of New Allotment Certificate in Lieu of Old Allotment Certificate",
  ...
  },
  {
    ...
    subItems: [
      { label: "Horticulture Activities", link: "/latest-activities/horticulture-activities" },
      { label: "PLANTATION DRIVE DHAI-R (MONSOON 2020)", link: "/latest-activities/plantation-drive-dhai-r-monsoon-2020" },
      { label: "Dengue Prevention Campaign", link: "/latest-activities/dengue-prevention-campaign" },
      { label: "Environmental Activities", link: "/latest-activities/environmental-activities" },
      { label: "Plantation Campaign", link: "/latest-activities/plantation-campaign" },
    ],
  },
  {
    label: "DHA Property Exchange",
    subItems: [
      { label: "Introduction & Services", link: "/dha-property-exchange/introduction-services" },
      { label: "Price Valuation Benchmarking", link: "/dha-property-exchange/price-valuation-benchmarking" },
      { label: "Sale of Property", link: "/dha-property-exchange/sale-of-property" },
      { label: "Rent a Property", link: "/dha-property-exchange/rent-a-home" },
      { label: "Purchase of Property", link: "/dha-property-exchange/purchase-of-property" },
  ...
  },
  {
    ...
    subItems: [
      { label: "Important Notice", link: "/member-portal/login" },
  ...
  },
  {
    label: "New Editions",
    subItems: [
      { label: "Property Listing", link: "https://demo.phpscriptpoint.com/realspoint/" },
      { label: "Home Services", link: "https://captainhomeservice.com/" },
      { label: "Resident Portal", link: "/new-editions/portal" },
      { label: "Complaint Management System", link: "https://demo.workdo.io/ticketgo/admin/dashboard" },
    ],
  },
];
